...
fun TaskCard(
    ...
    Swipeable(
        ...
        behavior = SwipeBehavior.DISMISS, // card dismisses when swiped
        threshold = 0.7f, // how far to swipe before action fires
        leftDismissAction = SwipeAction( // what happens on left swipe (complete)
        ...
        rightDismissAction = SwipeAction( // what happens on right swipe (delete)
            customization = ActionCustomization(
        ...
        Card(
            ...
            colors = CardDefaults.cardColors(
                if (directionState == SwipeDirection.RIGHT) {
                    lerp(
